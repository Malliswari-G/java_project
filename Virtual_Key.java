	...
	public static void main(String[] args) throws IOException
	{
		...
		do
		{
			System.out.println("Application name: ProtoType");
		        System.out.println("Developer name:  Malliswari");
			System.out.println("Developer email: mgutti@cisco.com");
			System.out.println("\n==== Select Option ====");
			...
			case 4:
				...
				try
				{
					...
					FileHandle.openFile("/Users/Admin/Desktop/java_project/");
					FileHandle.display(fileName, "/Users/Admin/Desktop/java_project/");
				}
				catch (Exception e)
				{
